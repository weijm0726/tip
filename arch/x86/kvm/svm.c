...
static void init_vmcb(struct vcpu_svm *svm)
{
	...
	control->iopm_base_pa = iopm_base | sme_me_mask;
	control->msrpm_base_pa = __pa(svm->msrpm) | sme_me_mask;
				   ...
				   unsigned long root)
{
	...
	svm->vmcb->control.nested_cr3 = root | sme_me_mask;
